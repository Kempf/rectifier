...
\bibliography{report}
\section*{Reflection}
This lab provided both important theoretical knowledge as well as the skills required to implement and test this theory. I learnt a lot considering the amount of time spent in the lab. The most significant thing I learnt was the importance of projecting and planning in the physical implementation of a circuit.
\end{document}
